// Versi CommonJS (bukan ES Module)
...
async function extractPDF() {
    try {
        ...
        // pdf-parse mengekspor class PDFParse, bukan fungsi langsung
        ...
        const searchTerms = ['matematika', 'bahasa indonesia', 'ipa', 'ipas', 'fase a', 'fase d'];
