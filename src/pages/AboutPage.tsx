...
// Komponen Pembungkus Ikon Kaca (selaras dengan gaya aplikasi)
...
export default function AboutPage({ installPrompt, onInstall, isPwaInstalled }: AboutPageProps) {
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-center gap-8">
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="flex flex-wrap justify-center sm:justify-start gap-3">
              <span className="px-4 py-1.5 bg-white/10 backdrop-blur-md rounded-full text-xs font-bold uppercase tracking-wider border border-white/20">Version 2.03j</span>
