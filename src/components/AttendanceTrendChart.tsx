...
interface ChartItem {
  ...
  total: number;
  displayDate?: string;
  hadirPct?: string | number;
}

interface CustomTooltipProps {
  active?: boolean;
  payload?: Array<{ payload: ChartItem; name: string; value: number }>;
}
...
const AttendanceTrendChart: React.FC = () => {
    ...
    useEffect(() => {
        const fetchAttendanceTrend = async () => {
            ...
            try {
                ...
                const attendanceByDate: Record<string, ChartItem> = {};
                ...
                let chartData: ChartItem[] = Object.values(attendanceByDate)
    ...
    }, [user, activeSemester, academicYear, viewMode]);
